            ...
            itemBuilder: (BuildContext context, int index) {
              return Container(
                ...
                child: _ViewItem(
                    ...
                    id: widget.userModelList[index].universityId ?? "",
                    initiallyExpanded: widget.initiallyExpanded,
                    selected: (val) {
...
class _ViewItem extends StatelessWidget {
  ...
  _ViewItem(
      {required this.item, required this.itemSelected, required this.selected, required this.initiallyExpanded, required this.id});

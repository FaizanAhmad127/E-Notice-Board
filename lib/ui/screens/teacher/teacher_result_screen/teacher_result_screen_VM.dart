...
class TeacherResultScreenVM extends ChangeNotifier{
  ...
  //      catch(error)
  //      {
  //        print('result model is null because there is no result document or any field is missing, it can happen '
  //            'when not a single teacher is selected in a committee'
  //            ' getStudentGroup/ teacher_result_screen_vm $error');
  //      }
  //      if(resultModel!=null)
  //        {
  //          if(resultModel!.teachersList.contains(uid)) ///getting list of  students group under this committee member
  //          {
  //

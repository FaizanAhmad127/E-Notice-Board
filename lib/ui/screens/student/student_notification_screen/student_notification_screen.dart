                ...
                child: Align(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if(ideaStatusModel?.statusTitle?.isNotEmpty??false)
                      Expanded(
                        flex: 2,
                        child: FittedBox(
                          child: Text("Remarks: ${ideaStatusModel.statusTitle??""}",
                            style: kPoppinsLight300.copyWith(
                              fontSize: 16.sp,
                              color: kBlackColor,
                            ),
              ...
              Expanded(
                  ...
                  Align(
                    ...
                    child: FittedBox(
                      ...
                      child: Text(ideaStatusModel.status=='accepted'?'Accepted':ideaStatusModel.status.toString(),
                        style: kPoppinsMedium500.copyWith(
                            fontSize: 14.sp,
              ...
              body: TabBarView(
                children: [
                  ...
                  Padding(padding: EdgeInsets.all(15),
                    ...
                    Center(
                      child: Text('List of Notice will appear here'),
                    ):
                    ListView.builder(

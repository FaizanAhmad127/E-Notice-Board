...
import 'coordinator_finalized_marks_screen.dart';
import 'coordinator_pending_marks_screen.dart';
import 'coordinator_result_status_screen_vm.dart';


class CoordinatorResultStatusScreen extends StatelessWidget {
   CoordinatorResultStatusScreen({Key? key}) : super(key: key);


  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create:(context)=>CoordinatorResultStatusScreenVM(),
      builder:(context,viewModel)
      {
        return  SafeArea(
          child: Scaffold(
            backgroundColor: kWhiteColor,
            body: Consumer<CoordinatorResultStatusScreenVM>(
                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(
                            ...
                            CoordinatorPendingMarksScreen():CoordinatorFinalizedMarksScreen(),

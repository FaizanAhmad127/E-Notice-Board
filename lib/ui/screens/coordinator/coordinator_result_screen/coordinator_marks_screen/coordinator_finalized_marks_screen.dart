...
import 'coordinator_finalized_marks_screen_vm.dart';
import 'coordinator_pending_marks_screen_vm.dart';

class CoordinatorFinalizedMarksScreen extends StatelessWidget {
  CoordinatorFinalizedMarksScreen({Key? key}) : super(key: key);
  ...
  double getFyp1Total(MarksModel marksModel, int index) {
    ...
    print("fyp1 total ${obe2}  ${obe3}  ${obe4}  ${fyp1Viva}");
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CoordinatorFinalizedMarksScreenVM(),
      builder: (context, viewModel) {
        return Consumer<CoordinatorFinalizedMarksScreenVM>(builder: (context, vm, child) {
          return Scaffold(

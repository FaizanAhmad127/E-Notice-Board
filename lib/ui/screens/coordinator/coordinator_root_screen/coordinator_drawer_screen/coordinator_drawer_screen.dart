...
class CoordinatorDrawerScreen extends StatelessWidget {
  CoordinatorDrawerScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        ...
        builder: (context, viewModel) {
          return Consumer<CoordinatorDrawerScreenVM>(
            builder: (context,vm,child)
            {
              if(vm.signupModel?.fullName!=null)
              {
                if(isFirstTime==false)
                {
                  fullNameController.text=vm.signupModel!.fullName??"";
                  occupationController.text=vm.signupModel!.occupation??"";
                  isFirstTime=true;
                }
                                          ...
                                          child: SizedBox(
                                              ...
                                              child: Stack(
                                                children: [
                                                  ...
                                                  Consumer<CoordinatorDrawerScreenVM>(
                                                      builder: (context, vm, child) {
                                            ...
                                            Expanded(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextButton(
                                                      onPressed: () {
                                                        Provider.of<CoordinatorDrawerScreenVM>(
                                                            context,
                                                            listen: false)
                                                            .signOut(context);
                                                      },

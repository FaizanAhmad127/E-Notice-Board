...
import '../coordinator_result_screen/coordinator_marks_screen/coordinator_result_status_screen.dart';
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  NavigationService()
                                      .navigatePush(context, CoordinatorResultStatusScreen());
                                },
                                child: Row(
                                            ...
                                            children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: CommitteeScrollView(
                                                          userType: 'teacher',
                                                          listOfCommitteeMembers: vm.listOfCommittees[index].convenerList,
                                              ...
                                              Expanded(
                                                  child: Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                      Text('Projects',style: kPoppinsSemiBold600.copyWith(
                                                      fontSize: 13
                                                  ),),
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(
          ...
          right: 0.01.sw),
      child:
      widget.userType=="student"?FutureBuilder(
        future: CoordinatorCommitteeScreenVm().getUserStdProfile(widget.listOfCommitteeMembers, widget.userType),
        builder: (context,AsyncSnapshot<List<IdeaModel?>> snapshot)
        {
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: Text(
                            '${index+1}. ${snapshot.data![index]!.ideaTitle??""}',
                            maxLines: 2,
                          ),
                        ),
                      ],

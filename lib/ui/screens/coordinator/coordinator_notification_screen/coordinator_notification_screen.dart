...
class CoordinatorNotificationScreen extends StatelessWidget {
  ...
  Widget notificationCard(SignupRequestModel requestModel,CoordinatorNotificationScreenVM vm)
  {
    return SizedBox(
      height: 110.h,
      width: 414.w,
                    ...
                    child: FittedBox(
                     child: Row(
                       children: [
                         GestureDetector(
                           onTap: ()async{
                             await vm.setApproval(requestModel.email??"", "no");
                         ...
                         GestureDetector(
                           onTap: ()async{
                            await vm.setApproval(requestModel.email??"", "yes");
                           },
                           child: Icon(
                             Icons.check_circle,
                             size: 25.r,
                ...
                body: SizedBox(
                  ...
                  child: Padding(
                    ...
                    :ListView.builder(
                        ...
                        {
                          return notificationCard(vm.listOfRequests[index],vm);
                        })
                  ),
                ),
              );

...
import 'package:notice_board/ui/screens/profile_screen/teacher_profile_screen.dart';
...
class CoordinatorTeacherListScreen extends StatelessWidget {
  ...
  Widget getItem(UserSignupModel teacher,BuildContext context) {
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                UserSignupModel teacher = vm
                                    .getSearchList[index];
                                return getItem(teacher,context);
                              })
                      ),
                    )

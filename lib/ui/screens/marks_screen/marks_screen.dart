...
class MarksScreen extends StatelessWidget {
  MarksScreen({required this.groups,Key? key}) : super(key: key);
  ...
  double getFyp1Total(MarksModel marksModel, int index) {
    ...
    print("fyp1 totttal ${obe2}  ${obe3}  ${obe4}  ${fyp1Viva} ${marksModel.uid}");
  ...
  double getObe2(MarksModel marksModel, int index) {
    double result = 0;
    print("obree ${marksModel.obe2}");
    marksModel.obe2.forEach((key, value) {
      print("obee ${result + value}");
      result = result + value;
    });
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => MarksScreenVM(groups),
                                                                ...
                                                                Expanded(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                             vm.userType!='student'?getObe2(vm.searchedStudentMarksMap.values.elementAt(index), index)
                                                                                 .toString()+" "+ vm.searchedStudentMarksMap.values.elementAt(index).OBE2Status:getObe2(vm.searchedStudentMarksMap.values.elementAt(index), index)
                                                                                 .toString(),
                                                                          style:

...
class StudentIdeaService {
  ...
  Future postIdea(String title, String desc, String ownerUID,List<String> studentsUid,
                 List<String> teachersUid,List<String> coadviserUid, String ideaType, List<PlatformFile> filesList, int ideaId) async
  {
      ...
      /// Adding files to firebase Storage
       await Future.forEach(filesList, (PlatformFile platformFile) async{
         ...
         IdeaModel ideaModel=IdeaModel(ideaId.toString(), ideaType, title,
             ...
             teachersUid,coadviserUid, fileModelList, ideaId);
          ...
          await _firebaseFirestore.collection("post").doc(ideaId).set({
            ...
            await Future.forEach(studentsUid, (sUid)async {
              await _firebaseFirestore
                  ...
                  .doc('2021-2022')
                  .collection('marks')
                  .doc(sUid.toString()).set(MarksModel(sUid.toString(),"no","").toJson());
            });

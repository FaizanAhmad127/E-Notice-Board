...
class Validate{
  ...
  bool validateChangePassword(String newPassword, String password,String confirmPassword)
  {
    if(newPassword.isEmpty || password.isEmpty|| confirmPassword.isEmpty)
    {
      BotToast.showText(text: "Warning! One of the TextField is empty",duration: Duration(seconds: 3));
      return false;
    }
      ...
      {
        BotToast.showText(text: "Same Password not Allowed",duration: Duration(seconds: 3));
        return false;
      }
      else if(newPassword==confirmPassword) {
          if (newPassword.length < 6 || confirmPassword.length < 6) {
            BotToast.showText(text: "Password should be at least 6 characters",
      ...
      BotToast.showText(text: "Something went wrong",duration: Duration(seconds: 3));
      return false;
    }
